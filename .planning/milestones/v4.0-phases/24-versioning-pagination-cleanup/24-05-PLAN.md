...
**Scope Note:** This plan touches 6+ files across the functions/ directory. This is intentional -
TODO cleanup naturally spans multiple files where the comments exist. Each file receives targeted
changes (removing/addressing specific TODOs), not broad rewrites. The multi-file scope is acceptable
because changes are independent and low-risk (comment removal, minor fixes).
</objective>
...
<success_criteria>
TEST-01: TODO comments resolved or documented as intentional
  - Research found 23 in app code, target 20+ addressed
  - Remaining marked as intentional future enhancements
  - Note: Original requirement said 30, updated to match reality (23 found)
</success_criteria>
