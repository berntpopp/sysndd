...
must_haves:
  ...
  artifacts:
    - path: "api/functions/omim-functions.R"
      ...
      exports: ["download_mim2gene", "parse_mim2gene", "fetch_jax_disease_name", "fetch_all_disease_names", "validate_omim_data"]
      min_lines: 150
...
- Return tibble with: mim_number, gene_symbol (Approved_Gene_Symbol_HGNC)
...
**6. build_omim_ontology_set(mim2gene_data, disease_names, hgnc_list, moi_list)**
...
```
  ...
  <done>
- omim-functions.R exists with all 6 functions
