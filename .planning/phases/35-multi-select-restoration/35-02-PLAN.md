...
3. Replace the phenotype BFormSelect (around lines 334-346) in the modifyReviewModal with TreeMultiSelect:
```vue
<!-- Replace this: -->
<!-- <BFormSelect
  v-if="phenotypes_options && phenotypes_options.length > 0"
...
4. Replace the variation BFormSelect (around lines 366-378) with TreeMultiSelect:
```vue
<!-- Replace this: -->
<!-- <BFormSelect
  v-if="variation_ontology_options && variation_ontology_options.length > 0"
...
3. Replace the phenotype BFormSelect (around lines 546-558) in the reviewModal with TreeMultiSelect:
```vue
<!-- Replace this: -->
<!-- <BFormSelect
  v-if="phenotypes_options && phenotypes_options.length > 0"
...
4. Replace the variation BFormSelect (around lines 578-590) with TreeMultiSelect:
```vue
<!-- Replace this: -->
<!-- <BFormSelect
  v-if="variation_ontology_options && variation_ontology_options.length > 0"
