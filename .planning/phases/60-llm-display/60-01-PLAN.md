...
<success_criteria>
1. Both API endpoints return cached summaries or 404
2. LlmSummaryCard.vue component renders summaries with AI provenance
3. AnalyseGeneClusters.vue shows summary card for single cluster selection
4. AnalysesPhenotypeClusters.vue shows summary card for active cluster
5. Missing summaries result in hidden section (no error, no placeholder)
6. Confidence badge shows High/Medium/Low with color coding
