...
4. Verify validation states display (try invalid email format)
  </verify>
  <done>
Login, Register, PasswordReset forms use Bootstrap-Vue-Next BForm components. Forms submit correctly. Validation states display.
  </done>
</task>
