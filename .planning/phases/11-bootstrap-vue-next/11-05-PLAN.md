...
Apply replacements file by file or use sed:
```bash
# Example sed patterns (run in app/src directory)
find . -name "*.vue" -exec sed -i 's/\bml-/ms-/g; s/\bmr-/me-/g; s/\bpl-/ps-/g; s/\bpr-/pe-/g' {} \;
```
...
```
  ...
  <done>
All ml-*/mr-*/pl-*/pr-* classes replaced with ms-*/me-*/ps-*/pe-*. Visual spacing intact.
  </done>
</task>
