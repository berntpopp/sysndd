...
- [ ] **Step 1: Write a failing generic-limiter test**
...
- [ ] **Step 3: Write failing protected-handler tests**
...
- [ ] **Step 4: Run protected-handler tests to verify they fail**
...
- [ ] **Step 1: Implement `per-caller-throttle.R`**
...
- [ ] **Step 2: Convert the clustering file to an adapter**
...
- [ ] **Step 3: Source the generic module first**
...
- [ ] **Step 4: Run generic and S6 tests to verify GREEN**
...
- [ ] **Step 1: Implement the auth adapter with safe defaults**
...
- [ ] **Step 2: Gate endpoints before expensive work**
...
- [ ] **Step 3: Run handler tests to verify GREEN**
...
- [ ] **Step 1: Run xhigh adversarial plan review and fold valid issues before production code**
...
- [ ] **Step 2: Document deploy configuration**
...
- [ ] **Step 3: Run xhigh adversarial diff review and fold findings with tests first**
...
- [ ] **Step 4: Run required gates and live verification**
...
- [ ] **Step 5: Commit, push, and open the child-only PR**
