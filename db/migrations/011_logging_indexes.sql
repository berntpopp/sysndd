...
ALTER TABLE logging ADD INDEX idx_logging_status (status);
...
ALTER TABLE logging ADD INDEX idx_logging_path (path(100));
...
ALTER TABLE logging ADD INDEX idx_logging_timestamp_status (timestamp, status);
...
ALTER TABLE logging ADD INDEX idx_logging_id_desc_status (id DESC, status);
