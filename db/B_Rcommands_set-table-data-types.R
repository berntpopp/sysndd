...
dbClearResult(rs)
rs <- dbSendQuery(sysndd_db, 'ALTER TABLE sysndd_db.disease_ontology_set MODIFY disease_ontology_name varchar(200);')
dbClearResult(rs)
...
dbClearResult(rs)
rs <- dbSendQuery(sysndd_db, 'ALTER TABLE sysndd_db.disease_ontology_set MODIFY DOID varchar(50);')
dbClearResult(rs)
rs <- dbSendQuery(sysndd_db, 'ALTER TABLE sysndd_db.disease_ontology_set MODIFY MONDO varchar(20);')
dbClearResult(rs)
rs <- dbSendQuery(sysndd_db, 'ALTER TABLE sysndd_db.disease_ontology_set MODIFY Orphanet varchar(200);')
dbClearResult(rs)
rs <- dbSendQuery(sysndd_db, 'ALTER TABLE sysndd_db.disease_ontology_set MODIFY EFO varchar(50);')
dbClearResult(rs)
