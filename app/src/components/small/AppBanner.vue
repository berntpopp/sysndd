    ...
    >
      <BRow>
        ...
        <BCol md="10">
          ...
          their health behavior on the basis of information contained on this website. SysNDD does
          not independently verify the information gathered from external sources. If you have
          questions about specific gene-disease claims, please contact the respective primary
          sources. If you have questions about the representation of the data on this website,
          please contact support [at] sysndd.org.<br /><br />
        ...
        <BCol md="1">
          <BButton variant="outline-dark" size="sm" @click="acknowledgeBanner()"> Dismiss </BButton>
        </BCol>
      </BRow>
    </BAlert>
  </div>
