...
export default {
  ...
  methods: {
    // Owns the reset for every close path (cancel, dismiss, successful
    // delete). Requires the parent to keep this component mounted: under
    // v-if the modal would unmount before @hidden fires.
    onHidden() {
