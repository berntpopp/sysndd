        ...
        <b-col col md="12">
          ...
          <b-row>
            ...
            <h6 class="mb-1 text-left font-weight-bold">
              {{ header_label }} <b-badge variant="primary" v-b-tooltip.hover.bottom v-bind:title="'Loaded ' + perPage + '/' + totalRows + ' in ' + executionTime">Entities: {{totalRows}} </b-badge>
            </h6>
  ...
  data() {
      ...
      methods: {
        ...
        async loadEntitiesData() {
          this.isBusy = true;
          let apiUrl = process.env.VUE_APP_API_URL + '/api/entity?sort=' + ((this.sortDesc) ? '-' : '+') + this.sortBy + '&filter=' + this.filter_string + '&page_after=' + this.currentItemID + '&page_size=' + this.perPage;
