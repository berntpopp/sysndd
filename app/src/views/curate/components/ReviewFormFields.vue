 ...
 *
 * Passed INTO VariationProvenanceZones rather than living there: the tree label
 * comes from `variationOptions`, which only this form has. The other surfaces
 * fall back to the component's own name-or-CURIE default rather than showing a
 * label nobody supplied.
 */
