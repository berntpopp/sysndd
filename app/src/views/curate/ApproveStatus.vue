...
async function handleAllStatusOk(): Promise<void> { if (!approve_all_selected.value) return; try { ax().put(`${apiBase()}/api/status/approve/all?status_ok=true`, {}, { headers: authHdr() }); loadStatusTableData(); } catch (e) { makeToast(e, 'Error', 'danger'); } }
