      ...
      <BRow class="justify-content-md-center py-4">
        ...
        >
          ...
          <BAccordion id="faq-accordion">
            <BAccordionItem
              title="What can I use SysNDD for?"
              visible
            >
              <template #title>
                ...
                <BListGroup flush>
                  <BListGroupItem class="bg-transparent d-flex">
                    ...
                    <div>
                      ...
                      distinguished by their level of evidence. Furthermore, gene lists can be filtered
                      based on associated phenotypes.
                    </div>
                  </BListGroupItem>
                  <BListGroupItem class="bg-transparent d-flex">
                    <BBadge
                    ...
                    <div>
                      Single entries can be searched and looked up either starting from a gene or from
                      a disease. Also lists and summaries on genes associated with a disease or diseases
                      associated with a particular gene can be retrieved.
                    </div>
                  </BListGroupItem>
                </BListGroup>
              </div>
            ...
            <BAccordionItem title="What are the criteria for inclusion?">
              ...
              <div class="py-2">
                ...
                >
                  ...
                  We only use information that is <strong>published</strong> and no unpublished data from
                  meetings/conferences, personal communication or in-house databases.
                </BAlert>
                <p>
                  This means that for all information contained in SysNDD the primary source can be retrieved.
                </p>
              </div>
            </BAccordionItem>
            ...
            <BAccordionItem title="What is the concept of entities?">
              ...
              <div class="py-2">
                <p>The core principle of SysNDD are immutable "gene-inheritance-disease" units, so called "entities".</p>

                <BCard
                  class="text-center mb-4 border-0 bg-primary bg-opacity-10"
                  body-class="py-4"
                >
                  <h4 class="mb-0">
                    <BBadge
                ...
                <p>
                  To allow interoperability and linking to other data sources, these entities are defined through
                  ontology terms:
                </p>
                <BListGroup flush>
                ...
                <p class="mt-3 text-muted">
                  ...
                  The mutational consequence is currently not active but will be implemented with the next updates.
                </p>
              </div>
            </BAccordionItem>
            ...
            <BAccordionItem title="Who is updating the data?">
              ...
              <div class="py-2">
                ...
                <p>
                  In future, experts from <strong>ERN ITHACA</strong> will be involved in the curation
            ...
            <BAccordionItem title="What makes SysNDD different?">
              ...
              <div class="py-2">
                <p>SysNDD is one of the few NDD-related databases that contains not only information on genes but also on:</p>
                <BRow class="text-center my-4">
                  <BCol sm="3">
                    <BCard
                      class="border-0 bg-success bg-opacity-10 h-100"
                      body-class="py-3"
                    >
                  ...
                  <BCol sm="3">
                    <BCard
                      class="border-0 bg-info bg-opacity-10 h-100"
                      body-class="py-3"
                    >
                  ...
                  <BCol sm="3">
                    <BCard
                      class="border-0 bg-warning bg-opacity-10 h-100"
                      body-class="py-3"
                    >
                  ...
                  <BCol sm="3">
                    <BCard
                      class="border-0 bg-danger bg-opacity-10 h-100"
                      body-class="py-3"
                    >
                ...
                <p>
                  All organized in <strong>entities</strong>. It is manually curated by a single or a limited
                  number of experts thus ensuring <strong>high confidence</strong> of the data.
                </p>
              </div>
            </BAccordionItem>
            ...
            <BAccordionItem title="Where can I find more documentation?">
              ...
              <div class="py-2">
                <p>
                  The SysNDD documentation is generated using bookdown and hosted on our GitHub docs page at:
                </p>
                <BCard
                  class="text-center border-0 bg-primary bg-opacity-10"
                  body-class="py-4"
                >
                  <BLink
                    href="https://berntpopp.github.io/sysndd/"
            ...
            <BAccordionItem title="Found a bug or want to help?">
              ...
              <div class="py-2">
                <p>
                  Ask questions, report bugs and chat about SysNDD in general using our:
                </p>
                <BCard
                  class="text-center border-0 bg-success bg-opacity-10"
                  body-class="py-4"
                >
                  <BLink
                    href="https://github.com/berntpopp/sysndd/discussions"
