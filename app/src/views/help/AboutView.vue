            ...
            <BAccordionItem title="About SysNDD and its creators" visible>
              ...
              <div class="py-2">
                <p>
                  ...
                  facilitate research and diagnostics into NDDs has been conceived by Annette
                  Schenck and Christiane Zweier.
                </p>
                <p>
                  ...
                  candidate genes according to the degree of underlying evidence. Furthermore,
                  expert curated information on associated diseases and phenotypes was provided.
                </p>
                <p>
                  Christiane Zweier has been updating SysID from its start in 2009. Together with
                  her, Bernt Popp has now developed and programmed the new SysNDD database.
                </p>
                <p>
                  To allow interoperability and mapping between gene-, phenotype- or
                  disease-oriented databases, SysNDD is centered around curated
                  gene-inheritance-disease units, so called entities, which are classified based on
                  three evidence categories. This can account for the increased complexity of NDDs
                  and allows to address a broader spectrum of diagnostic and research questions.
                </p>
                <p>
                  Future functionality will be expanded to annotation of variant and network
                  analyses. Another goal is to incorporate the SysID/SysNDD data into other
                ...
                <BListGroup flush>
                  ...
                  <BListGroupItem class="bg-transparent">
                    ...
                    (BIH) at Charite Berlin, Germany and scientist at the Institute of Human
                    Genetics at the University Hospital Leipzig, Germany
                  </BListGroupItem>
                  <BListGroupItem class="bg-transparent">
                    <strong>Annette Schenck:</strong> Radboud university medical center, Nijmegen,
                    the Netherlands
                  </BListGroupItem>
                </BListGroup>
              </div>
                ...
                <BCard class="mb-3 border-start border-primary border-4" body-class="py-3">
                  <p class="mb-2">
                    ...
                    <BLink href="https://pubmed.ncbi.nlm.nih.gov/26748517/" target="_blank">
                      ...
                      Oortveld MA, Kleefstra T, Kramer JM, Webber C, Huynen MA, Schenck A.
                      Systematic Phenomics Analysis Deconvolutes Genes Mutated in Intellectual
                      Disability into Biologically Coherent Modules. Am J Hum Genet. 2016 Jan
                      7;98(1):149-64. doi: 10.1016/j.ajhg.2015.11.024. PMID: 26748517; PMCID:
                      PMC4716705.
                    </BLink>
                  </p>
                </BCard>
            ...
            <BAccordionItem title="Support and Funding">
              ...
              <div class="py-2">
                ...
                <BListGroup flush>
                  ...
                  <BListGroupItem class="bg-transparent">
                    <i class="bi bi-check-circle text-secondary me-2" />
                    VIDI and TOP grants (917-96-346, 912-12-109) from The Netherlands Organisation
                    for Scientific Research (NWO) to
                    <BLink href="https://orcid.org/0000-0002-6918-3314" target="_blank"
                      >Annette Schenck</BLink
                    >
                  </BListGroupItem>
            ...
            <BAccordionItem title="Credits and acknowledgement">
              ...
              <div class="py-2">
                <p>
                  ...
                  Radboud University Medical Center Nijmegen, The Netherlands, for building SysID
                  and supporting it for many years.
                </p>
                <p>
                  We would also like to thank all past users for using SysID and for constructive
                  feedback, thus making the sometimes tedious updates and re-organization into the
                  new SysNDD database worthwhile.
                </p>
                <p>
                  Since recently, Alain Verloes and ERN ITHACA provide valuable encouragement and
                  support by initiating and supporting the data integration with Orphanet and
                  helping with the recruitment of expert curators.
                </p>
              </div>
            </BAccordionItem>
