<template>
  <div class="public-page documentation-page">
    ...
    <div v-else class="public-shell">
      ...
      <!-- Quick Links -->
      <nav class="public-actions" aria-label="Documentation links">
        <BLink :href="DOCS_URLS.HOME" target="_blank" class="public-action-card">
          <span class="public-action-card__icon">
            <i class="bi bi-file-earmark-text" aria-hidden="true" />
          </span>
          <span>
            <span class="public-action-card__label">Full Documentation</span>
            <span class="public-action-card__meta">Bookdown manual</span>
          </span>
        </BLink>
        <BLink :href="DOCS_URLS.GITHUB_DISCUSSIONS" target="_blank" class="public-action-card">
          <span class="public-action-card__icon">
            <i class="bi bi-chat-dots" aria-hidden="true" />
          </span>
          <span>
            <span class="public-action-card__label">Discussions</span>
            <span class="public-action-card__meta">Questions and support</span>
          </span>
        </BLink>
        <BLink :href="DOCS_URLS.GITHUB_ISSUES" target="_blank" class="public-action-card">
          <span class="public-action-card__icon">
            <i class="bi bi-bug" aria-hidden="true" />
          </span>
          <span>
            <span class="public-action-card__label">Report Issues</span>
            <span class="public-action-card__meta">GitHub tracker</span>
          </span>
        </BLink>
      </nav>

      <!-- FAQ Accordion -->
      <section class="public-panel" aria-label="Frequently asked questions">
        <BAccordion id="faq-accordion">
              ...
              <BListGroup flush>
                ...
                <BListGroupItem class="bg-transparent d-flex">
                  ...
                  <div>
                    ...
                    a disease. Also lists and summaries on genes associated with a disease or
          ...
          <BAccordionItem title="What is the concept of entities?">
            ...
            <div class="py-2">
              ...
              <p class="mt-3 text-muted">
                ...
                The mutational consequence is currently not active but will be implemented with the
                next updates.
              </p>
            </div>
          </BAccordionItem>
          ...
          <BAccordionItem title="What makes SysNDD different?">
            ...
            <div class="py-2">
              <p>
                SysNDD is one of the few NDD-related databases that contains not only information on
                genes but also on:
              </p>
              ...
              <p>
                All organized in <strong>entities</strong>. It is manually curated by a single or a
                limited number of experts thus ensuring <strong>high confidence</strong> of the
                data.
              </p>
            </div>
          </BAccordionItem>
