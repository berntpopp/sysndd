...
export default {
  ...
  async loadEntityInfo() {
    this.loading = true;
    let apiEntityURL = process.env.VUE_APP_API_URL + '/alb/entity/' + this.$route.params.sysndd_id;
    let apiStatusURL = process.env.VUE_APP_API_URL + '/alb/entity/' + this.$route.params.sysndd_id + '/status';
    let apiReviewURL = process.env.VUE_APP_API_URL + '/alb/entity/' + this.$route.params.sysndd_id + '/review';
    let apiPublicationsURL = process.env.VUE_APP_API_URL + '/alb/entity/' + this.$route.params.sysndd_id + '/publications';
    let apiPhenotypesURL = process.env.VUE_APP_API_URL + '/alb/entity/' + this.$route.params.sysndd_id + '/phenotypes';
    try {
