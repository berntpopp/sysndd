...
#
# Selection logic (submit-field allowlist, WHERE/param builders, gene-atomic
# matching, preview, and manual-pick available-entity listing) lives in
# re-review-selection-service.R (#346), sourced BEFORE this file — batch_create()
# and batch_recalculate() below call its select_matching_entities().
