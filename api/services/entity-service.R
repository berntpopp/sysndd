...
# ---------------------------------------------------------------------------
# svc_entity_create_with_review_status, svc_entity_create_full, and
# svc_entity_rename_full moved to services/entity-creation-service.R and
# services/entity-rename-service.R respectively (#346, Wave 4 Task 2) to
# keep this file under the 600-line ceiling. Both depend on
# svc_entity_validate / svc_entity_check_duplicate defined above and must
# be sourced after this file (see api/bootstrap/load_modules.R).
# ---------------------------------------------------------------------------
