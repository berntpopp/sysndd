#### This file holds function for interaction with external ressources
...
post_url_archive <- function(parameter_url,
    ...
    if (url_valid) {
    # based on https://docs.google.com/document/d/1Nsv52MvSjbLb2PCpHlat0gkzw0EvtSgpKHu4mk0MnrA/edit
    ...
    # TODO: more meaningfull response
