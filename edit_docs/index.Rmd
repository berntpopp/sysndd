...
link-citations: yes
colorlinks: yes
description: "This documentation is intended to describe the SysNDDproject and provide instructions for regular usershow to use the tool and for curator status users how to perform reviews and how to enter data"
graphics: yes
...
This documentation is intended to describe the [SysNDD](https://sysndd.dbmr.unibe.ch/) project and provide instructions for regular usershow to use the tool and for curator status users how to perform reviews and how to enter data.
