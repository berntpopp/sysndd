...
![Login menu](./static/img/sysndd_login.png){max-width=800px}

<br/>
On the Login page enter your credentials and press the Login button:

![Login page](./static/img/sysndd_login_page.png){max-width=400px}
...
![Login token menu](./static/img/sysndd_refresh_token.png){max-width=300px}
...
![Review page menu](./static/img/sysndd_review_page_menu.png){max-width=1000px}

<br/>
The “Re-Review” page is structured as a table enriched with information and controls.

![Review page](./static/img/sysndd_review_page.png){max-width=1000px}
...
&nbsp;&nbsp;&nbsp;&nbsp; **(1)** entities review (![Edit review menu](./static/img/edit_review_button.png){max-width=50px})

&nbsp;&nbsp;&nbsp;&nbsp; **(2)** the status (![Edit status menu](./static/img/edit_status_button.png){max-width=50px})

&nbsp;&nbsp;&nbsp;&nbsp; **(3)** and to submit your work (![Submit re-review status menu](./static/img/submit_re-review_button.png){max-width=50px})
...
![Review page](./static/img/modal_modify_review.png){max-width=1000px}
...
- suggest it’s overall removal **(2)**,
- add a comment for your change suggestions for the Curators to better understand the proposal **(3)** and
- save your work **(4)**:

![Submit re-review modal](./static/img/modal_modify_status.png){max-width=800px}
...
![Submit re-review modal](./static/img/modal_submit_re-review.png){max-width=400px}
