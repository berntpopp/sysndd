...
![Login menu](./static/img/sysndd_login.png){width=800px}

<br/>
On the Login page enter your credentials and press the Login button:

![Login page](./static/img/sysndd_login_page.png){width=400px}
...
![Login token menu](./static/img/sysndd_refresh_token.png){width=400px}
...
![Review page menu](./static/img/sysndd_review_page_menu.png){width=1000px}

<br/>
The “Re-Review” page is structured as a table enriched with information and controls.

![Review page](./static/img/sysndd_review_page.png){width=1000px}
...
&nbsp;&nbsp;&nbsp;&nbsp; **(1)** entities review (![Edit review menu](./static/img/edit_review_button.png){width=50px})

&nbsp;&nbsp;&nbsp;&nbsp; **(2)** the status (![Edit status menu](./static/img/edit_status_button.png){width=50px})

&nbsp;&nbsp;&nbsp;&nbsp; **(3)** and to submit your work (![Submit re-review status menu](./static/img/submit_re-review_button.png){width=50px})
...
<img src="./static/img/modal_modify_review.png" alt="Review page" width="1000"/>
...
![Submit re-review modal](./static/img/modal_modify_status.png){width=800px}
...
![Submit re-review modal](./static/img/modal_submit_re-review.png){width=400px}
