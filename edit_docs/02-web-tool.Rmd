...
The *Table* tab displays a table format for comparing the presence of a gene in different neurodevelopmental disorder curation efforts. This tab also includes the option to download the comparison table as an Excel file. The filter removal button is in the upper right corner.
...
A smiley face button (in blue, bottom right) is present on every page of SysNDD and directs users to the following assistance and feedback functions:
