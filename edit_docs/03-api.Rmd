...
![Authenticate endpoint](./static/img/03_01-api-authenticate.png){max-width=1000px}

This endpoint will generate and respond with and JWT token:

![JWT token](./static/img/03_02-JWT-token.png){max-width=1000px}
...
![Authorize button](./static/img/03_03-api-authorize-a.png){max-width=1000px}

![Authorize modal prompt](./static/img/03_04-api-authorize-b.png){max-width=1000px}
...
![Authorize modal logged in](./static/img/03_05-api-authorize-c.png){max-width=1000px}

The user is now fully authenticated and can access the endpoints requiring user rights:

![API logged in](./static/img/03_06-api-authorize-d.png){max-width=1000px}
