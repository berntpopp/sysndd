...
disable the startup scrub (default on). The remaining durable job families (publication/hgnc/ontology/
comparisons/omim/provider/pubtator/llm-batch) still carry `db_config` in payload
and are migrated to the same resolver in a follow-up (S2b).
