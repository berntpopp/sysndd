...
<br/>
By clicking the action buttons, you can open three different windows to change the entity review:

&nbsp;&nbsp;&nbsp;&nbsp; **(1)** entity review (![Edit review menu](./static/img/edit_review_button.png){width="50px"})
