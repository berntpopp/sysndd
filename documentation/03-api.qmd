...
Publication outputs include `recommended_citation`, `publication_date_sysndd_record`, `publication_date_confidence`, and optional abstract fields controlled by `abstract_mode`; linked entity review dates are reported separately as `sysndd_curation_date`. `recommended_citation` omits the year when the publication date is unverified.
