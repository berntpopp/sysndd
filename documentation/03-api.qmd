...
This Bearer token can then be copied into the OpenAPI/Swagger authorization modal, which opens after clicking the "Authorize" button in the API documentation interface. After authorization, the user can access endpoints requiring user rights until the token expires.
