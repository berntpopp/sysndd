...
Public and MCP analysis sections such as phenotype correlations, phenotype clusters, and STRING-derived gene networks require public-ready analysis snapshots. MCP reports snapshot diagnostics such as `snapshot_missing` or `snapshot_stale`; it does not compute heavy analysis or read draft/admin data on miss.
